...
function CompanyLogin(props) {
  ...
  const getData = async () => {
    ...
    return(
      <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center',backgroundColor:"#cce6ff",paddingTop:50 }}>
      <View>
        <Text style={{ fontSize: 50, color: '#000080', fontWeight: 'bold' }}>Company Login</Text>
      </View>
      ...
      <View style={{ margin: 20, width: 110}}>
        <Button color="#000080" onPress={()=> props.navigation.navigate("CompanySignUp")}  title="Signup"></Button>
      </View>
      </View>
    )
}
